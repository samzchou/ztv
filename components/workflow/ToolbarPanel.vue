...
@font-face {
    ...
    src: url('~assets/iconfont/iconfont.eot?t=1566199791492#iefix')
        ...
        url('~assets/iconfont/iconfont.ttf?t=1566199791492')
            format('truetype'),
