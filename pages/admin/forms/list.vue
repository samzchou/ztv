    ...
    <section class="formlist-container">
        <div class="forms">
            ...
            <div class="right">
                ...
                <el-button type="text" icon="el-icon-user" @click="addNew" style="margin-left:10px;">新增表单</el-button>
            </div>
        </div>
        <div class="tables">
...
export default {
    ...
    methods: {
        ...mapMutations('forms', ['CLEAR_FORMS', 'UPDATE_FORMS']),
        showCode(code) {
        ...
        addNew() {
            this.CLEAR_FORMS(true);
            window.location.href = '/admin/forms/addNew';
        },
        removeItem(row) {
        ...
        editItem(item) {
            ...
            this.UPDATE_FORMS(item.content);
            window.location.href = '/admin/forms/addNew';
        },
        currentChange(page) {
